  ...
  <div class="footer-container">
    <div class="footer-top">
      ...
      <ul class="footer-list">
        ...
        <li class="footer-list-item"><a target="_blank" href="#">채용</a></li>
      </ul>
    ...
    <div class="footer-bottom">
      <div id="copyright">
        <ul class="copyright-list">
          <li class="copyright-list-item">고객문의 <a href="#">cs@aaa.com</a></li>
          <li class="copyright-list-item">제휴문의 <a href="#">contact@aaa.com</a></li>
        </ul>
        <ul class="copyright-list">
          <li class="copyright-list-item">지역광고 <a href="#">ad@aaa.com</a></li>
          <li class="copyright-list-item">PR문의 <a href="#">pr@aaa.com</a></li>
        </ul>
        ...
        <div id="social">
          <ul class="social-list">
            <li class="social-list-item">
              <a target="_blank" class="footer-social-link" href="#">
